...
class LatestCompetitiveUpdate:
    ...
    def from_dict(obj: Any) -> 'LatestCompetitiveUpdate':
        ...
        ranked_rating_after_update = from_int(
            obj.get("RankedRatingAfterUpdate"))
        ranked_rating_before_update = from_int(
            obj.get("RankedRatingBeforeUpdate"))
        ranked_rating_earned = from_int(obj.get("RankedRatingEarned"))
        ranked_rating_performance_bonus = from_int(
            obj.get("RankedRatingPerformanceBonus"))
    ...
    def to_dict(self) -> dict:
        ...
        result["RankedRatingAfterUpdate"] = from_int(
            self.ranked_rating_after_update)
        result["RankedRatingBeforeUpdate"] = from_int(
            self.ranked_rating_before_update)
        result["RankedRatingEarned"] = from_int(self.ranked_rating_earned)
        result["RankedRatingPerformanceBonus"] = from_int(
            self.ranked_rating_performance_bonus)
...
class The2_De5423B4_Aad02_Ad8_D9BC0A931958861:
    ...
    def from_dict(obj: Any) -> 'The2_De5423B4_Aad02_Ad8_D9BC0A931958861':
        ...
        number_of_wins_with_placements = from_int(
            obj.get("NumberOfWinsWithPlacements"))
        ...
        total_wins_needed_for_rank = from_int(
            obj.get("TotalWinsNeededForRank"))
    ...
    def to_dict(self) -> dict:
        ...
        result["NumberOfWinsWithPlacements"] = from_int(
            self.number_of_wins_with_placements)
        ...
        result["TotalWinsNeededForRank"] = from_int(
            self.total_wins_needed_for_rank)
        return result
...
class The0981_A8824_E7D371_A70_C4C3B4F46C504A:
    ...
    def from_dict(obj: Any) -> 'The0981_A8824_E7D371_A70_C4C3B4F46C504A':
        ...
        total_wins_needed_for_rank = from_int(
            obj.get("TotalWinsNeededForRank"))
        wins_by_tier = from_union([lambda x: from_dict(
            from_int, x), from_none], obj.get("WinsByTier"))
    ...
    def to_dict(self) -> dict:
        ...
        result["TotalWinsNeededForRank"] = from_int(
            self.total_wins_needed_for_rank)
        result["WinsByTier"] = from_union(
            [lambda x: from_dict(from_int, x), from_none], self.wins_by_tier)
        return result
...
class CompetitiveSeasonalInfoBySeasonID:
    ...
    def from_dict(obj: Any) -> 'CompetitiveSeasonalInfoBySeasonID':
        assert isinstance(obj, dict)
        the_0981_a882_4_e7_d_371_a_70_c4_c3_b4_f46_c504_a = The0981_A8824_E7D371_A70_C4C3B4F46C504A.from_dict(
            obj.get("0981a882-4e7d-371a-70c4-c3b4f46c504a"))
        the_2_de5423_b_4_aad_02_ad_8_d9_b_c0_a931958861 = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("2de5423b-4aad-02ad-8d9b-c0a931958861"))
        the_34093_c29_430643_de_452_f_3_f944_bde22_be = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("34093c29-4306-43de-452f-3f944bde22be"))
        the_3_e47230_a_463_c_a301_eb7_d_67_bb60357_d4_f = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("3e47230a-463c-a301-eb7d-67bb60357d4f"))
        the_4401_f9_fd_41702_e4_c_4_bc3_f3_b4_d7_d150_d1 = The4401F9Fd41702E4C4Bc3F3B4D7D150D1.from_dict(
            obj.get("4401f9fd-4170-2e4c-4bc3-f3b4d7d150d1"))
        the_573_f53_ac_41_a5_3_a7_d_d9_ce_d6_a6298_e5704 = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("573f53ac-41a5-3a7d-d9ce-d6a6298e5704"))
        the_67_e373_c7_48_f7_b422_641_b_079_ace30_b427 = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("67e373c7-48f7-b422-641b-079ace30b427"))
        the_7_a85_de9_a_403261_a9_61_d8_f4_aa2_b4_a84_b6 = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("7a85de9a-4032-61a9-61d8-f4aa2b4a84b6"))
        the_9_c91_a445_4_f78_1_baa_a3_ea_8_f8_aadf4914_d = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("9c91a445-4f78-1baa-a3ea-8f8aadf4914d"))
        aca29595_40_e4_01_f5_3_f35_b1_b3_d304_c96_e = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("aca29595-40e4-01f5-3f35-b1b3d304c96e"))
        d929_bc38_4_ab6_7_da4_94_f0_ee84_f8_ac141_e = The2_De5423B4_Aad02_Ad8_D9BC0A931958861.from_dict(
            obj.get("d929bc38-4ab6-7da4-94f0-ee84f8ac141e"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["0981a882-4e7d-371a-70c4-c3b4f46c504a"] = to_class(
            The0981_A8824_E7D371_A70_C4C3B4F46C504A, self.the_0981_a882_4_e7_d_371_a_70_c4_c3_b4_f46_c504_a)
        result["2de5423b-4aad-02ad-8d9b-c0a931958861"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_2_de5423_b_4_aad_02_ad_8_d9_b_c0_a931958861)
        result["34093c29-4306-43de-452f-3f944bde22be"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_34093_c29_430643_de_452_f_3_f944_bde22_be)
        result["3e47230a-463c-a301-eb7d-67bb60357d4f"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_3_e47230_a_463_c_a301_eb7_d_67_bb60357_d4_f)
        result["4401f9fd-4170-2e4c-4bc3-f3b4d7d150d1"] = to_class(
            The4401F9Fd41702E4C4Bc3F3B4D7D150D1, self.the_4401_f9_fd_41702_e4_c_4_bc3_f3_b4_d7_d150_d1)
        result["573f53ac-41a5-3a7d-d9ce-d6a6298e5704"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_573_f53_ac_41_a5_3_a7_d_d9_ce_d6_a6298_e5704)
        result["67e373c7-48f7-b422-641b-079ace30b427"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_67_e373_c7_48_f7_b422_641_b_079_ace30_b427)
        result["7a85de9a-4032-61a9-61d8-f4aa2b4a84b6"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_7_a85_de9_a_403261_a9_61_d8_f4_aa2_b4_a84_b6)
        result["9c91a445-4f78-1baa-a3ea-8f8aadf4914d"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.the_9_c91_a445_4_f78_1_baa_a3_ea_8_f8_aadf4914_d)
        result["aca29595-40e4-01f5-3f35-b1b3d304c96e"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.aca29595_40_e4_01_f5_3_f35_b1_b3_d304_c96_e)
        result["d929bc38-4ab6-7da4-94f0-ee84f8ac141e"] = to_class(
            The2_De5423B4_Aad02_Ad8_D9BC0A931958861, self.d929_bc38_4_ab6_7_da4_94_f0_ee84_f8_ac141_e)
        return result
...
class Competitive:
    ...
    def from_dict(obj: Any) -> 'Competitive':
        assert isinstance(obj, dict)
        total_games_needed_for_rating = from_int(
            obj.get("TotalGamesNeededForRating"))
        total_games_needed_for_leaderboard = from_int(
            obj.get("TotalGamesNeededForLeaderboard"))
        current_season_games_needed_for_rating = from_int(
            obj.get("CurrentSeasonGamesNeededForRating"))
        seasonal_info_by_season_id = CompetitiveSeasonalInfoBySeasonID.from_dict(
            obj.get("SeasonalInfoBySeasonID"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["TotalGamesNeededForRating"] = from_int(
            self.total_games_needed_for_rating)
        result["TotalGamesNeededForLeaderboard"] = from_int(
            self.total_games_needed_for_leaderboard)
        result["CurrentSeasonGamesNeededForRating"] = from_int(
            self.current_season_games_needed_for_rating)
        result["SeasonalInfoBySeasonID"] = to_class(
            CompetitiveSeasonalInfoBySeasonID, self.seasonal_info_by_season_id)
        return result
...
class Deathmatch:
    ...
    total_games_needed_for_leaderboard: int
    current_season_games_needed_for_rating: int
    seasonal_info_by_season_id: Dict[str,
                                     The0981_A8824_E7D371_A70_C4C3B4F46C504A]
    ...
    def from_dict(obj: Any) -> 'Deathmatch':
        ...
        current_season_games_needed_for_rating = from_int(
            obj.get("CurrentSeasonGamesNeededForRating"))
        seasonal_info_by_season_id = from_dict(
            The0981_A8824_E7D371_A70_C4C3B4F46C504A.from_dict, obj.get("SeasonalInfoBySeasonID"))
    ...
    def to_dict(self) -> dict:
        ...
        result["CurrentSeasonGamesNeededForRating"] = from_int(
            self.current_season_games_needed_for_rating)
        result["SeasonalInfoBySeasonID"] = from_dict(lambda x: to_class(
            The0981_A8824_E7D371_A70_C4C3B4F46C504A, x), self.seasonal_info_by_season_id)
        return result
...
class Hurm:
    ...
    def from_dict(obj: Any) -> 'Hurm':
        ...
        current_season_games_needed_for_rating = from_int(
            obj.get("CurrentSeasonGamesNeededForRating"))
        seasonal_info_by_season_id = HurmSeasonalInfoBySeasonID.from_dict(
            obj.get("SeasonalInfoBySeasonID"))
    ...
    def to_dict(self) -> dict:
        ...
        result["CurrentSeasonGamesNeededForRating"] = from_int(
            self.current_season_games_needed_for_rating)
        result["SeasonalInfoBySeasonID"] = to_class(
            HurmSeasonalInfoBySeasonID, self.seasonal_info_by_season_id)
        return result
...
class NewmapSeasonalInfoBySeasonID:
    ...
    def from_dict(obj: Any) -> 'NewmapSeasonalInfoBySeasonID':
        assert isinstance(obj, dict)
        the_67_e373_c7_48_f7_b422_641_b_079_ace30_b427 = The0981_A8824_E7D371_A70_C4C3B4F46C504A.from_dict(
            obj.get("67e373c7-48f7-b422-641b-079ace30b427"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["67e373c7-48f7-b422-641b-079ace30b427"] = to_class(
            The0981_A8824_E7D371_A70_C4C3B4F46C504A, self.the_67_e373_c7_48_f7_b422_641_b_079_ace30_b427)
        return result
...
class Newmap:
    ...
    def from_dict(obj: Any) -> 'Newmap':
        ...
        current_season_games_needed_for_rating = from_int(
            obj.get("CurrentSeasonGamesNeededForRating"))
        seasonal_info_by_season_id = NewmapSeasonalInfoBySeasonID.from_dict(
            obj.get("SeasonalInfoBySeasonID"))
    ...
    def to_dict(self) -> dict:
        ...
        result["CurrentSeasonGamesNeededForRating"] = from_int(
            self.current_season_games_needed_for_rating)
        result["SeasonalInfoBySeasonID"] = to_class(
            NewmapSeasonalInfoBySeasonID, self.seasonal_info_by_season_id)
        return result
...
class SeedingSeasonalInfoBySeasonID:
    ...
    def from_dict(obj: Any) -> 'SeedingSeasonalInfoBySeasonID':
        assert isinstance(obj, dict)
        the_573_f53_ac_41_a5_3_a7_d_d9_ce_d6_a6298_e5704 = The0981_A8824_E7D371_A70_C4C3B4F46C504A.from_dict(
            obj.get("573f53ac-41a5-3a7d-d9ce-d6a6298e5704"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["573f53ac-41a5-3a7d-d9ce-d6a6298e5704"] = to_class(
            The0981_A8824_E7D371_A70_C4C3B4F46C504A, self.the_573_f53_ac_41_a5_3_a7_d_d9_ce_d6_a6298_e5704)
        return result
...
class Seeding:
    ...
    def from_dict(obj: Any) -> 'Seeding':
        ...
        current_season_games_needed_for_rating = from_int(
            obj.get("CurrentSeasonGamesNeededForRating"))
        seasonal_info_by_season_id = SeedingSeasonalInfoBySeasonID.from_dict(
            obj.get("SeasonalInfoBySeasonID"))
    ...
    def to_dict(self) -> dict:
        ...
        result["CurrentSeasonGamesNeededForRating"] = from_int(
            self.current_season_games_needed_for_rating)
        result["SeasonalInfoBySeasonID"] = to_class(
            SeedingSeasonalInfoBySeasonID, self.seasonal_info_by_season_id)
        return result
...
class PlayerMMRResponse:
    ...
    def from_dict(obj: Any) -> 'PlayerMMRResponse':
        ...
        new_player_experience_finished = from_bool(
            obj.get("NewPlayerExperienceFinished"))
        queue_skills = QueueSkills.from_dict(obj.get("QueueSkills"))
        latest_competitive_update = LatestCompetitiveUpdate.from_dict(
            obj.get("LatestCompetitiveUpdate"))
        is_leaderboard_anonymized = from_bool(
            obj.get("IsLeaderboardAnonymized"))
    ...
    def to_dict(self) -> dict:
        ...
        result["NewPlayerExperienceFinished"] = from_bool(
            self.new_player_experience_finished)
        result["QueueSkills"] = to_class(QueueSkills, self.queue_skills)
        result["LatestCompetitiveUpdate"] = to_class(
            LatestCompetitiveUpdate, self.latest_competitive_update)
        result["IsLeaderboardAnonymized"] = from_bool(
            self.is_leaderboard_anonymized)
        result["IsActRankBadgeHidden"] = from_bool(
            self.is_act_rank_badge_hidden)
        return result
